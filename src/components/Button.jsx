  ...
  return (
    <div >
      ...
      <Modal isOpen={modal} toggle={toggleModal}>
        <ModalHeader toggle={toggleModal}>Modal başlığı</ModalHeader>
        ...
        <ModalFooter>
          <Button color="primary" className='bg-orange-500' onClick={() => handleChange()}>
            Redakte et
          </Button>
          <Button color="secondary"  className=' bg-slate-400' onClick={() => handleDefault()} >
            Ləğv et
          </Button>
        </ModalFooter>
      </Modal>
